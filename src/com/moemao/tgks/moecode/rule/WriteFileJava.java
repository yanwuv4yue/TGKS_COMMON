    ...
    public void writeAction(Module module) throws IOException
    {
        ...
        try
        {
            ...
            */
            ...
            write("CommonUtil.systemLog(\"" + moduleTag + "/edit" + upper + ".action\", CommonConstant.SYSTEMLOG_TYPE_1, result == 0 ? CommonConstant.FAILD : CommonConstant.SUCCESS, String.format(\"新增" + moduleEvt + "\\n%S\", " + moduleEvt + ".toString()));");
            write("}");
            write("else");
            write("{");
            write("result = " +moduleService + ".update" + upper + "(" + moduleEvt + ");");
            write("CommonUtil.systemLog(\"" + moduleTag + "/edit" + upper + ".action\", CommonConstant.SYSTEMLOG_TYPE_2, result == 0 ? CommonConstant.FAILD : CommonConstant.SUCCESS, String.format(\"修改" + moduleEvt + "\\n%S\", " + moduleEvt + ".toString()));");
            write("}");
            ...
            write("CommonUtil.systemLog(\"" + moduleTag + "/delete" + upper + ".action\", CommonConstant.SYSTEMLOG_TYPE_3, result == 0 ? CommonConstant.FAILD : CommonConstant.SUCCESS, String.format(\"删除" + moduleEvt + "\\nID:%S\", ids));");
            write("CommonUtil.infoLog(logger, CommonConstant.SYSTEM_INFO_LOG_METHOD_EXECUTE_NUMS, StringUtil.toBeString(result));");
